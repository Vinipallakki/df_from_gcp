...
def run():
    ...
    transformed_data = (
        messages
        | 'Parse Pub/Sub messages' >> beam.Map(parse_pubsub_message)
        | 'Window into fixed intervals' >> beam.WindowInto(beam.window.FixedWindows(60))  # Example: 60-second fixed window
    )
