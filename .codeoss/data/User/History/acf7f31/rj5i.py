...
def run():
    options = PipelineOptions(
        ...
        staging_location='gs://banded-edge-437103-i9/staging/',  # Replace with your GCS bucket
        temp_location='gs://banded-edge-437103-i9/temp/',  # Replace with your GCS bucket
        region='us-central1',
    ...
    lines | 'Write to BigQuery' >> WriteToBigQuery(
        table='banded-edge-437103-i9:my_realtime_dataset.realtime_table',  # Replace with your BQ table
