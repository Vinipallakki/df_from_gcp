...
def run():
    ...
    read_from_pubsub = p | "ReadFromPubSub" >> beam.io.ReadFromPubSub(input_topic)
    parse_json = read_from_pubsub | "ParseJson" >> beam.Map(parse_json).with_output_types(CommonLog)

# ... rest of your code using read_from_pubsub and parse_json variables
